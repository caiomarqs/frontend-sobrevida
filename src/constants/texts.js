export default {
    ...
    'informacao.titulo2':'Para ser doador de órgãos e tecidos',
    'informacao.conteudo2':'Basta avisar sua família, dizendo: “Quero ser doador de órgãos”. A doação só acontece após a autorização familiar documentada.',
    'informacao.titulo3':'',
    'informacao.conteudo3':'',
    ...
    'estatistica.titulo':'Compararação entre número de Transplantes e pacientes ativos por Lista de Espera em 2020',
    'estatistica.label1':'Número de transplantes',
    'estatistica.label2':'Pacientes por lista de espera',
    'estatistica.button1':'Coração',
    'estatistica.button2':'Figado',
    'estatistica.button3':'Pulmão',
    'estatistica.button4':'Pâncreas',
    'estatistica.button5':'Rim',
    'estatistica.button6':'Córnea',
    ...
    'perguntas.resposta2':'Todas podem ser consideradas doadoras em potencial, independentemente da idade ou histórico médico. O que determinará a possibilidade de transplante e quais os órgãos e tecidos que poderão ser doados é uma avaliação do corpo feita por meio de exames clínicos, de imagem laboratoriais no momento da morte.',
    'perguntas.pergunta3':'Como funciona a lista de espera?',
    ...
    'perguntas.pergunta4':'Como ser um doador?',
    'perguntas.resposta4':'Só para ter ideia de como é simples, você não precisa deixar nada por escrito em nenhum documento. Para ser doador, basta avisar os familiares de primeiro ou segundo grau. Para facilitar a comunicação com seus familiares criamos o cadastro de doador onde você poderá enviar sua vontade periodicamente.',
    'perguntas.pergunta5':'O corpo fica deformado depois da retirado dos órgãos?',
    'perguntas.resposta5':'Como os órgãos e tecidos doados são removidos cirurgicamente, em uma operação de rotina (similar a uma cirurgia de vesícula), o corpo não sofre alterações na aparência.',
    'perguntas.pergunta6':'O que é morte encefálica?',
    'perguntas.resposta6':'A morte encefálica consiste na perda total e irreversível das funções cerebrais.',
