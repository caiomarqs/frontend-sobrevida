        ...
        <section id="depoimentos-section">
            <div className="container">
                ...
                <div id="depoimentos-container">
                    ...
                    <Depoimento img={require('../../assets/img/XzA0Mjg2MzcuanBn.jpg')} title={constants['depoimento2.titulo']} subTitle={constants['depoimento2.subTitulo']} body={constants['depoimento2.body']}/>
